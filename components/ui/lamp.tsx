...
export const LampContainer = ({
	...
	return (
		<div
			className={cn(
				"relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-green-950 w-full rounded-md z-0",
				className
			)}>
			<div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
				...
				<motion.div
					...
					className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-slate-400 blur-2xl"></motion.div>
				<motion.div
					initial={{ width: "15rem" }}
